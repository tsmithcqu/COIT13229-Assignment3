...
public class CreateDeliveryScheduleAdmin extends JFrame {
    ...
    public CreateDeliveryScheduleAdmin() {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            CreateDeliveryScheduleAdmin createDeliveryScheduleAdmin = new CreateDeliveryScheduleAdmin();
            createDeliveryScheduleAdmin.setVisible(true);
        });
    }
}
